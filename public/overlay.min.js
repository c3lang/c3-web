 ...
 * Original file: /npm/@preline/overlay@2.0.2/index.js
 *
              ...
              var e = {
                  ...
                  770: function (e, t, o) {
                      ...
                      s = (function (e) {
                        function t(t, o, n) {
                          ...
                          return (
                            ...
                            (a.isClosePrev =
                              null ===
                                (i = null == d ? void 0 : d.isClosePrev) ||
                              void 0 === i ||
                              i),
                            (a.backdropClasses =
                              null !==
                                (s = null == d ? void 0 : d.backdropClasses) &&
                              void 0 !== s
                                ? s
                            ...
                            (a.autoHide = null),
                            (a.overlayId =
                              a.el.getAttribute("data-hs-overlay")),
                        ...
                        return (
                              ...
                              this.overlay.addEventListener(
                                ...
                                function (t) {
                                  t.target.id &&
                                    ...
                                    "true" ===
                                      e.hasAbilityToCloseOnBackdropClick &&
                                    e.close();
                                }
                              );
                          }),
                          ...
                          (t.prototype.open = function () {
                            ...
                            var t = window.$hsOverlayCollection.find(function (
                                e
                              ) {
                                return (
                                  e.element.overlay ===
                            ...
                            o && (document.body.style.overflow = "hidden"),
                              ...
                              setTimeout(function () {
                                if (e.overlay.classList.contains(e.hiddenClass))
                                  return !1;
                          ...
                          (t.getInstance = function (e, t) {
                            var o = window.$hsOverlayCollection.find(function (
                              t
                            ) {
                              return (
                                t.element.el ===
                          ...
                          (t.autoInit = function () {
                            window.$hsOverlayCollection ||
                              ...
                              document
                                ...
                                .forEach(function (e) {
                                  window.$hsOverlayCollection.find(function (
                                    t
                                  ) {
                                    var o;
                                    return (
                          ...
                          (t.open = function (e) {
                            ...
                            t &&
                              t.element.overlay.classList.contains(
                          ...
                          (t.accessibility = function (e) {
                            var t,
                              o,
                              n = window.$hsOverlayCollection.filter(function (
                                e
                              ) {
                                return e.element.overlay.classList.contains(
                                  "open"
                                );
                              }),
                              i = n[n.length - 1],
                            ...
                            a &&
                              s.length &&
                              "Tab" === e.code &&
                              (e.preventDefault(), this.onTab(i, s)),
                              a &&
                                "Escape" === e.code &&
                          ...
                          (t.on = function (e, t, o) {
                            var n = window.$hsOverlayCollection.find(function (
                              e
                            ) {
                              return (
                                e.element.el ===
                    ...
                    window.addEventListener("load", function () {
                      ...
                      "undefined" != typeof window && (window.HSOverlay = s),
                      (t.default = s);
                  },
                  969: function (e, t) {
                    var o = this;
                    ...
                    t.htmlToElement = function (e) {
                      ...
                      return (
                        (e = e.trim()), (t.innerHTML = e), t.content.firstChild
                      );
                    };
