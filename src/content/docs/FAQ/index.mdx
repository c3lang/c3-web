...
If running this command returns an error, your Linux distribution is more than likely missing the required packages needed for generating this MSVC folder.
