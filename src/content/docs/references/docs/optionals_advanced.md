...
The force [unwrap](../optionals#unwrapping-an-optional) operator `!!` 
will cause the program to panic and exit if the expression is “Empty”. 
...
// Returns Optional “Result” with `int` type or an “Empty” with an “Excuse”
