...
slug: c3-0-7-0-one-step-closer-to-1-0
search:
  exclude: true
---
...
While the language has evolved during this year, each 0.6.x version has been [backwards compatible](../../getting-started/roadmap.md) with code written for previous 0.6 versions. Despite this constraint, there have been a lot of improvements, 
