...
slug: c3-0-7-2-quality-of-life
search:
  exclude: true
---

Unlike 0.7.1, 0.7.2 is not about big new features, instead it is laser focused on adding quality of life improvements, which are [backwards compatible](../../getting-started/roadmap.md#c3-is-feature-stable) with other 0.7 releases. 
...
Learn more about [macros](../../generic-programming/macros.md) and [compile time evaluation](../../generic-programming/compiletime.md).
:::
...
Learn more about [strings](../../language-common/strings.md).
:::
