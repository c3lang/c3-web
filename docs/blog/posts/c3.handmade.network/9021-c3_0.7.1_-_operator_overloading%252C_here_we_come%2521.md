---
title: "C3 0.7.1 - Operator overloading, here we come!"
date: 2025-04-30
...
*Originally from: [https://c3.handmade.network/blog/p/9021-c3_0.7.1_-_operator_overloading%252C_here_we_come%2521](https://c3.handmade.network/blog/p/9021-c3_0.7.1_-_operator_overloading%252C_here_we_come%2521)*
...
Operator overloading is the biggest change of course, which is already covered in great detail [here](9019-c3_goes_game_and_maths_friendly_with_operator_overloading.md). The `@operator`, `@operator_s` and `@operator_r` attributes are used to enable overloading for user defined types.

### More static checking

An important step towards correctness is that `@require` contracts for functions are now inlined at the caller site for
