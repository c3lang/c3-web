...
Passing a [slice](../language-common/arrays.md#slice)
...
Passing the pointer to an [array](../language-common/arrays.md)
...
If this is desired, declare the left hand side an [Optional](../language-common/optionals-essential.md#what-is-an-optional):
