...
The force [unwrap](../language-common/optionals-essential.md#unwrapping-optional) operator `!!` will
...
[`if (catch)`](../language-common/optionals-essential.md#checking-if-an-optional-is-empty)
...
Retrieving the `Excuse` with [`if (catch excuse = optional_value) {...}`](../language-common/optionals-essential.md#checking-if-an-optional-is-empty)
is not the only way to get the `Excuse` from an Optional, we can use the macro `@catch` instead.
Unlike `if (catch)` this will never cause automatic [unwrapping](../language-common/optionals-essential.md#unwrapping-optional).
...
[`if (catch foo = optional_value)`](../language-common/optionals-essential.md#checking-if-an-optional-is-empty),
