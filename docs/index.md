      ...
      <div style="display: flex; flex-direction: column; gap: 0.5rem; justify-content: center; align-items: center; text-align: center;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.25rem; margin-top: 0.5rem; align-items: center;">
          ...
          <div style="display: flex; gap: 0.5rem; justify-content: center; flex-wrap: wrap;">
            ...
            <a href="https://play.c3-lang.org/" class="lp-get-started-btn lp-read-docs-btn" style="gap: 0.25rem;">
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.5 6L5.25 5.25H18.75L19.5 6V18L18.75 18.75H5.25L4.5 18V6ZM6 6.75V17.25H18V6.75H6ZM10.1894 12L7.71973 9.5303L8.78039 8.46964L12.3107 12L8.78039 15.5303L7.71973 14.4696L10.1894 12ZM12 15.75H15.75V14.25H12V15.75Z" fill="currentColor"/></svg>
        ...
        <div class="lp-code-header">
          ...
          <div class="lp-code-select-wrapper">
            <select class="lp-code-select">
              ...
              <option value="tab-4">Distinct types and aliases</option>
            </select>
          </div>
        </div>
    ...
    <div class="lp-feature-list">
      ...
      <div class="lp-feature-item">
        ...
        <div class="lp-feature-content">
          ...
          <p>A simple and straightforward module system that doesn't get in the way, with defaults that make sense.</p>
        </div>
      </div>
      <div class="lp-feature-item">
        <div class="lp-feature-icon-circle">
...
<hr style="height: 2px; margin: 4rem auto 4rem auto; background-color: var(--md-default-fg-color--lightest); border: none;">
  ...
  <div class="lp-feature-grid-8">
    ...
    <div class="lp-grid-feature">
      <div class="lp-grid-feature-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24"><path d="M8.293 6.293 2.586 12l5.707 5.707 1.414-1.414L5.414 12l4.293-4.293zm7.414 11.414L21.414 12l-5.707-5.707-1.414 1.414L18.586 12l-4.293 4.293z"/></svg>
      </div>
      <div class="lp-feature-content">
    ...
    <div class="lp-grid-feature">
      <div class="lp-grid-feature-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24"><path d="M11 6h2v5h-2zm0 6h2v2h-2z"/><path d="M20 2H4c-1.103 0-2 .897-2 2v18l5.333-4H20c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zm0 14H6.667L4 18V4h16v12z"/></svg>
      </div>
      <div class="lp-feature-content">
    ...
    <div class="lp-grid-feature">
      <div class="lp-grid-feature-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24"><path d="M22 8a.76.76 0 0 0 0-.21v-.08a.77.77 0 0 0-.07-.16.35.35 0 0 0-.05-.08l-.1-.13-.08-.06-.12-.09-9-5a1 1 0 0 0-1 0l-9 5-.09.07-.11.08a.41.41 0 0 0-.07.11.39.39 0 0 0-.08.1.59.59 0 0 0-.06.14.3.3 0 0 0 0 .1A.76.76 0 0 0 2 8v8a1 1 0 0 0 .52.87l9 5a.75.75 0 0 0 .13.06h.1a1.06 1.06 0 0 0 .5 0h.1l.14-.06 9-5A1 1 0 0 0 22 16V8zm-10 3.87L5.06 8l2.76-1.52 6.83 3.9zm0-7.72L18.94 8 16.7 9.25 9.87 5.34zM4 9.7l7 3.92v5.68l-7-3.89zm9 9.6v-5.68l3-1.68V15l2-1v-3.18l2-1.11v5.7z"/></svg>
      </div>
      <div class="lp-feature-content">
    ...
    <div class="lp-grid-feature">
      <div class="lp-grid-feature-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24"><path d="M21 5c0-1.103-.897-2-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5zM5 19V5h14l.002 14H5z"/><path d="M7 7h1.998v2H7zm4 0h6v2h-6zm-4 4h1.998v2H7zm4 0h6v2h-6zm-4 4h1.998v2H7zm4 0h6v2h-6z"/></svg>
      </div>
      <div class="lp-feature-content">
