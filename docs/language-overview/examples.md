...
Read more about optionals and error handling [here](../language-common/optionals-essential.md#what-is-an-optional).
...
Read more about macros [here](../generic-programming/macros.md).
...
Read more about compile time execution [here](../generic-programming/compiletime.md).
...
Read more about operator overloading [here](../generic-programming/operator-overloading.md).
...
Read more about generics [here](../generic-programming/generics.md)
...
Read more about dynamic calls [here](../generic-programming/anyinterfaces.md).
