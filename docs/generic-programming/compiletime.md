...
See [the "including binary data" secton of the expressions page](../language-fundamentals/expressions.md#including-binary-data) to see a few different usage examples.
