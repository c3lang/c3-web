...
You can also customize the path where the project will be created or specify a *template*. For more information check the [init command reference](../build-your-project/build-commands.md#init-a-new-project).
...
If you need more detail later on check [C3 project build commands](../build-your-project/build-commands.md) and [C3 project configuration](../build-your-project/project-config.md) to learn more.
